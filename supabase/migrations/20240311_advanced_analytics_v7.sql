-- Update advanced analytics to include incomes in Kassa calculation
...
BEGIN
    ...
    -- Net profit traditionally doesn't include capital injections (incomes from owner)
    -- but Kassa definitely does.
    ...
    RETURN json_build_object(
        'stats', json_build_object(
            ...
            'kassa', v_revenue - v_expenses + v_incomes,
